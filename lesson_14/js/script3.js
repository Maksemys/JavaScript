...
const totalPrice = dataList.reduce((accumPrice, el) => (accumPrice += el.price) , 0)

console.log(totalPrice)

// 2)Знайти кількість товарів, у яких ціна зменшилась (price < old_price).

const numberOfProductsWhosePriceHasDecreased = dataList.reduce((count, el) => el.price < el.old_price ? count + 1 : count, 0)

console.log(numberOfProductsWhosePriceHasDecreased)

// 3) Товари, які доступні (sell_status:"available")

const availableProducts = dataList.filter(el => el.sell_status === "available")

console.log(availableProducts)

// 4) сформувати новий список об”єктів тільки доступних  для продажу товарів, які міститимуть тільки ідентифікатор товару (id), нову ціну (price), стару ціну (old_price), та ціну у доларах (usd_price)

const newAvailableProductsList = availableProducts.map(el => ({id: el.id, price: el.price, old_price: el.old_price, usd_price: el.usd_price}))
